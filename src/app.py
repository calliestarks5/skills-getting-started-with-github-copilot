...
@app.get("/activities/{activity_name}/unregister")
def unregister_from_activity_get(activity_name: str, email: str = Query(...)):
    """Remove a student from an activity (GET for debugging)"""
